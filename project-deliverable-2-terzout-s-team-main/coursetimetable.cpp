    ...
    , currentUser(user)
{
    ...
    if (student) {
        // debugging output: Check the current state of the course lists
        ...
        // set column width for fall courses table
